...
今年WC咕到了8月这属实没想到，而且考试的时候我们教练还允许自带~~键盘~~

T1性质蛮容易发现，但是这玩意考场属实不会维护(~~你毛爷爷就是你毛爷爷~~)，最后链的分也没写 $20pts$ 跑路

弃了T1后开T3发现 $p=0$ 可以贪心一部分再DP一部分，考到一半还修改了下发样例，虽然我觉得这玩意正确性有点问题，但是还是拿到了 $40pts$

T2玩了蛮久，最后才发现这是一道签到题，考场原根那里憨了，只写了 $n^2\sqrt p$ 然后 $50pts$，直接白给

最后 $20+50+40=110$ 银牌滚粗（说实话不憨就有 $160pts$ 了），希望 $APIO2020$ 与 $NOI2020$ 可以取得好成绩吧